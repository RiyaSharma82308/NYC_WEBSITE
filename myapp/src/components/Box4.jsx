  ...
  return (
    <div>
      <div>
        <div
          style={{
            backgroundColor: "#4950A2",
            border: "0.06vw solid #4950A2",
            width: "100%",
            height: "44.3vw",
            top: "101.9vw",
            left: "0.63vw",
        ...
        >
          <div className="text-overlay" style={{ marginTop: "3.16vw" }}>
            ...
            >
              {clickedImgviolet2 && (
                <Modalright
                  clickedImg={clickedImgviolet2}
                  handelRotationRight={handelRotationRight_violet2}
                  setClickedImg={setClickedImgviolet2}
                />
              )}
            </div>
          </div>
          ...
          <div>
            <div style={{ marginLeft: "48.7vw" }}>
              {data.dataviolet2.map((item, index) => (
                <div
                  key={index}
                ...
                >
                  <img
                    src={item.link}
                    alt={item.text}
                    onClick={() => handleClickviolet2(item, index)}
                  />
                </div>
              ))}
            </div>
