      ...
      <div>
        <div
          style={{
            ...
            marginBottom: "2rem", // Add margin at the bottom to create space
          }}
        >
          <span
            style={{
          ...
          <span
            style={{
              ...
              textAlign: "left", // Align text to the left
              marginTop: "1rem", // Add some top margin to separate the spans
            }}
          >
        ...
        <div style={{ marginBottom: "3rem", marginLeft:"3vw" }}> {/* Add margin at the bottom to move the next section down */}
